            ...
            return `
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-0 text-center text-sm">
                            <button data-id="${r.id}" class="edit-btn inline-flex items-center justify-center w-6 h-6 bg-white hover:bg-slate-50 hover:text-red-600  text-slate-400 rounded-sm shadow-sm transition" title="Edit">
                            ...
                            <button data-id="${r.id}" class="delete-btn inline-flex items-center justify-center w-6 h-6 ml-1 bg-white hover:bg-red-50 hover:text-red-600 text-slate-400 rounded-sm shadow-sm transition" title="Delete">
