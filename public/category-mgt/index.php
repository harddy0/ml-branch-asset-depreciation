...
<div class="mb-4 mt-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
        ...
        <div class="w-full">
            <label for="filter-category-type" class="text-xs font-mono text-slate-400 block mb-2 sm:mb-0 pl-5">Filter by Category Type</label>
            <div class="relative">
                ...
                <button type="button" id="filter-category-type-clear" aria-label="Clear filter"
