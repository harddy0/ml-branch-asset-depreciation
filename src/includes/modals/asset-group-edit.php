<div id="asset-group-edit-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
        <div class="bg-slate-50 px-6 py-4 border-b border-slate-100 flex justify-between items-center">
            <h3 class="font-black text-slate-800 uppercase tracking-wide">Edit Asset Group</h3>
            <button type="button" onclick="closeModal('asset-group-edit-modal')" class="text-slate-400 hover:text-red-600 transition-colors">
        ...
        <form id="formEditAssetGroup">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    <label class="block text-xs font-black text-slate-600 uppercase tracking-wide mb-1">Asset GL Code <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-xs font-black text-slate-600 uppercase tracking-wide mb-1">Expense GL Code <span class="text-red-500">*</span></label>
